...
def find_cdr(seq, TAG, recordid):
    ...
    fr = seq[int(seqstart):int(cdr1_begin_pos)+1] + seq[int(cdr1_end_pos)+2:int(cdr2_begin_pos)+1] + seq[int(cdr2_end_pos)+2:int(cdr3_begin_pos)+1] + seq[int(cdr3_end_pos)+2:int(seqend)+1]   
    with open('fra.fasta', 'a') as f:
        f.write(recordid+"\n")
        f.write(fr+"\n")
...
for record in fasta_sequences:
    #seq based
    print "PDB", record.id
    cdrseq = find_cdr(record.seq,TAG,record.id)
'''
    #str based
    ...
    if res == "ERROR":
        ...
        ftag = ">"+record.id[:4]+"_"+record.id[5:6]+"_"+"cdr1"+"_"+chaintype+"_"+str(len(cdrseq[0]))
        with open('cdrseq_'+str(len(cdrseq[0]))+'.fasta', 'a') as f:
            f.write(ftag+"\n")
            f.write(cdrseq[0]+"\n")
        outfile = record.id[:4]+"_"+record.id[5:6]+"_"+"cdr1"+"_"+chaintype+"_"+str(len(cdrseq[0]))+".pdb"
    ...
    if res == "ERROR":
        ...
        ftag = ">"+record.id[:4]+"_"+record.id[5:6]+"_"+"cdr2"+"_"+chaintype+"_"+str(len(cdrseq[1]))
        with open('cdrseq_'+str(len(cdrseq[1]))+'.fasta', 'a') as f:
            f.write(ftag+"\n")
            f.write(cdrseq[1]+"\n")
        outfile = record.id[:4]+"_"+record.id[5:6]+"_"+"cdr2"+"_"+chaintype+"_"+str(len(cdrseq[1]))+".pdb"
        res.dump_pdb(outfile)
    ...
    if res == "ERROR":
        ...
        ftag = ">"+record.id[:4]+"_"+record.id[5:6]+"_"+"cdr3"+"_"+chaintype+"_"+str(len(cdrseq[2]))
        with open('cdrseq_'+str(len(cdrseq[2]))+'.fasta', 'a') as f:
            f.write(ftag+"\n")
            f.write(cdrseq[2]+"\n")
        outfile = record.id[:4]+"_"+record.id[5:6]+"_"+"cdr3"+"_"+chaintype+"_"+str(len(cdrseq[2]))+".pdb"
        res.dump_pdb(outfile)
    ...
    if res == "ERROR":
        ...
        ftag = ">"+record.id[:4]+"_"+record.id[5:6]+"_"+"hv4"+"_"+chaintype+"_"+str(len(cdrseq[3]))
        with open('cdrseq_'+str(len(cdrseq[3]))+'.fasta', 'a') as f:
            f.write(ftag+"\n")
            f.write(cdrseq[3]+"\n")
        outfile = record.id[:4]+"_"+record.id[5:6]+"_"+"hv4"+"_"+chaintype+"_"+str(len(cdrseq[3]))+".pdb"
        res.dump_pdb(outfile)
'''
