...
for record in fasta_sequences:
    ...
    if pdbregex:
        ...
        pos_cdr1s = inpose.pdb_info().pdb2pose(chainid,23)
        pos_cdr1e = inpose.pdb_info().pdb2pose(chainid,43)
        pos_cdr2s = inpose.pdb_info().pdb2pose(chainid,55)
        pos_cdr2e = inpose.pdb_info().pdb2pose(chainid,91)
        pos_cdr3s = inpose.pdb_info().pdb2pose(chainid,106)
        pos_cdr3e = inpose.pdb_info().pdb2pose(chainid,139)
        CDR1_match = False            
